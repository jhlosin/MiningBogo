...
// color
export const brandPrimary = 'white'//COLOR[mainColor + '500']
...
// card
export const cardDefaultBg = '#3db087'//COLOR[mainColor + '800']
export const cardBorderColor = '#0c855a'//COLOR[mainColor + '700']

// text
export const textColor = 'white' //COLOR[mainColor + '50']
